...
inputFiles = [
        [file: 'concept.adoc',       formats: ['html','pdf', 'docx', 'docbook']],
]
...
String user = System.getProperty("confluence.user")
if (user == null) throw new IllegalStateException("No user was set")
String password = System.getProperty("confluence.plainPassword")
if (password == null) throw new IllegalStateException("No password was set")
...
confluence.with {
    input = [
            [ file: "build/html5/concept.html" ],
    ]

    // endpoint of the confluenceAPI (REST) to be used
    api = 'https://confluence.intra.vsa.de/rest/api/'
...
//    Additionally, spaceKey, createSubpages, pagePrefix and pageSuffix can be globally defined here. The assignment in the input array has precedence
    ...
    */
    credentials = "${user}:${password}".toString().bytes.encodeBase64().toString()
