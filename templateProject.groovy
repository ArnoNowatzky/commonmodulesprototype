...
inputParamGroup.inputParams.add(new ConfirmInputParam('ui', "Needs ui", null))
inputParamGroup.inputParams.add(new ConfirmInputParam('ahelp', "Needs ahelp", null))
inputParamGroup.inputParams.add(new ConfirmInputParam('authentication', "Needs authentication", null))
